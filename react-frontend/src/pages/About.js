    ...
    return (
      <React.Fragment>
        <div className="about-wrapper">
          <h2>This is the Demo for a project I'm currently working on.</h2>
          <p>
            <strong>Disclaimer:</strong> It is still in progress and not
            optimized for security an performance.
          </p>
          <p>
            for detailed information check the projects{" "}
            <a href="https://github.com/markusphil/joinIn">GitHub Pages</a>
          </p>
          <br />
          <h1>Impressum</h1>
          ...
          <h2>Kontakt</h2>
          <p>E-Mail: m.philipp1991@web.de</p>
